...
#ifdef VULTURE_NETHACK_3_6_0
  vulture_getmsghistory,
  vulture_putmsghistory,
  //vulture_status_init,
  genl_status_init,
  genl_status_finish,
  genl_status_enablefield,
  genl_status_update,
  //vulture_status_update,
  genl_can_suspend_no
#endif
};
...
/* XXX Remove Video
#if defined(_WIN32) || defined(__APPLE__) || defined(__x86_64) || defined(__amd64)
  // Don't show intro on Linux 32bit
...
#ifdef VULTURE_NETHACK_3_6_0
void vulture_print_glyph(winid window, XCHAR_P x, XCHAR_P y, int glyph, int bkglyph)
#else
...
#ifdef VULTURE_NETHACK_3_6_0
void vulture_outrip(int winid, int how, time_t when)
#else
