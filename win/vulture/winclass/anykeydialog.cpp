...
eventresult
anykeydialog::handle_mousemotion_event(window *target, void *result, int xrel,
                                       int yrel, int state)
{
...
eventresult
anykeydialog::handle_mousebuttonup_event(window *target, void *result,
...
eventresult
anykeydialog::handle_keydown_event(window *target, void *result, int sym,
                                   int mod, int unicode)
{
    char key;
    int i;
...
eventresult
anykeydialog::handle_resize_event(window *target, void *result, int w, int h)
{
    x = (parent->w - w) / 2;
    y = (parent->h - h) / 2;
    return V_EVENT_HANDLED_NOREDRAW;
