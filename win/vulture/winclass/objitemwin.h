...
{
  public:
    objitemwin(window *p, menuitem *mi, std::string cap, char accel,
               char group_accel, int glyph, bool selected, bool multiselect);
    virtual bool draw();
    ...
    virtual eventresult handle_mousebuttonup_event(window *target,
                                                   ...
                                                   int state);
    virtual eventresult handle_other_event(window *target, void *result,
                                           SDL_Event *event);
