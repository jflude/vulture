...
eventresult
contextmenu::handle_mousemotion_event(window *target, void *result, int xrel,
                                      int yrel, int state)
{
...
eventresult
contextmenu::handle_mousebuttonup_event(window *target, void *result,
...
void
contextmenu::add_item(const char *label, int menuid)
{
