...
eventresult
enhancebutton::handle_timer_event(window *target, void *result, int time)
{
...
eventresult
enhancebutton::handle_mousemotion_event(window *target, void *result,
...
eventresult
enhancebutton::handle_mousebuttonup_event(window *target, void *result,
...
eventresult
enhancebutton::handle_resize_event(window *target, void *result, int res_w,
                                   int res_h)
{
...
void
enhancebutton::check_enhance(void)
{
    int to_advance = 0, i;
    bool prev_vis;
